            ...
            reply(msg).then(msg => {
                ...
                collector.on('collect', async interaction => {
                    ...
                    if (interaction.customId.endsWith("transfer")) { // Transfer Ownership
                        ...
                        voiceChannel.members.filter(member => !tempChannel.allowed_users.includes(member.id) && member.id !== user.id && !bypassRoles.some(role => Utils.hasRole(member, role, false))).forEach(member => {
