    ...
    if (interaction.isCommand()) {
        ...
        if (id == "verification_button") {
            ...
            if (id == "reactfor_ticket") {
                require("../modules/methods/createTicket")(bot, [], interaction.member, interaction.channel, true, 5000, false, config.Tickets.Channel.Category, config.Tickets.TicketCreatedMessage.Enabled, null, false, { ephemeral: true, interaction });
            } else if (id == "reactfor_application") {
                require("../modules/methods/createApplication")(bot, interaction.member, interaction.channel, true, 5000, null, null, { ephemeral: true, interaction });
            } else if (id.startsWith("reactfor_application_")) {
                require("../modules/methods/createApplication")(bot, interaction.member, interaction.channel, true, 5000, undefined, id.replace("reactfor_application_", ""), { ephemeral: true, interaction });
            }
        } else {
